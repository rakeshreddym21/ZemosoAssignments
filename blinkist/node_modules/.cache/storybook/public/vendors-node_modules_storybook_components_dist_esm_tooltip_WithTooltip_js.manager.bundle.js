"use strict";
(globalThis["webpackChunkblinkist"] = globalThis["webpackChunkblinkist"] || []).push([["vendors-node_modules_storybook_components_dist_esm_tooltip_WithTooltip_js"],{

/***/ "./node_modules/@storybook/components/dist/esm/tooltip/WithTooltip.js":
/*!*****************************************************************************************!*\
  !*** ./node_modules/@storybook/components/dist/esm/tooltip/WithTooltip.js + 61 modules ***!
  \*****************************************************************************************/
  ...
  modifiers.forEach(function (modifier) {
    ...
    .filter(function (value, index, self) {
      ...
      switch (key) {
        ...
        case 'phase':
          if (enums.modifierPhases.indexOf(modifier.phase) < 0) {
            console.error(format(INVALID_MODIFIER_ERROR, modifier.name, '"phase"', "either " + enums.modifierPhases.join(', '), "\"" + String(modifier.phase) + "\""));
          }
    ...
    var instance = {
      ...
      setOptions: function setOptions(setOptionsAction) {
        ...
        if (true) {
          ...
          if (getBasePlacement(state.options.placement) === enums.auto) {
...
function mapToStyles(_ref2) {
  ...
  if (adaptive) {
    ...
    if (placement === enums.top || (placement === enums.left || placement === enums.right) && variation === enums.end) {
      sideY = enums.bottom;
    ...
    if (placement === enums.left || (placement === enums.top || placement === enums.bottom) && variation === enums.end) {
      sideX = enums.right;
...
function distanceAndSkiddingToXY(placement, rects, offset) {
  ...
  var invertDistance = [enums.left, enums.top].indexOf(basePlacement) >= 0 ? -1 : 1;
  ...
  return [enums.left, enums.right].indexOf(basePlacement) >= 0 ? {
    x: distance,
    y: skidding
  } : {
    x: skidding,
...
function offset(_ref2) {
  ...
  var data = enums.placements.reduce(function (acc, placement) {
...
function getClientRectFromMixedType(element, clippingParent) {
  return clippingParent === enums.viewport ? rectToClientRect(getViewportRect(element)) : isElement(clippingParent) ? getInnerBoundingClientRect(clippingParent) : rectToClientRect(getDocumentRect(getDocumentElement(element)));
...
function getExpandedFallbackPlacements(placement) {
  if (getBasePlacement(placement) === enums.auto) {
    return [];
  }
...
function flip(_ref) {
  ...
  var placements = [preferredPlacement].concat(fallbackPlacements).reduce(function (acc, placement) {
    return acc.concat(getBasePlacement(placement) === enums.auto ? computeAutoPlacement(state, {
      placement: placement,
      boundary: boundary,
      rootBoundary: rootBoundary,
      padding: padding,
  ...
  for (var i = 0; i < placements.length; i++) {
    ...
    var isStartVariation = getVariation(placement) === enums.start;
...
var toPaddingObject = function toPaddingObject(padding, state) {
  ...
  return mergePaddingObject(typeof padding !== 'number' ? padding : expandToHashMap(padding, enums.basePlacements));
};
...
function arrow(_ref) {
  ...
  var isVertical = [enums.left, enums.right].indexOf(basePlacement) >= 0;
  ...
  var minProp = axis === 'y' ? enums.top : enums.left;
  var maxProp = axis === 'y' ? enums.bottom : enums.right;
...
function isAnySideFullyClipped(overflow) {
  return [enums.top, enums.right, enums.bottom, enums.left].some(function (side) {
...
var TooltipContext = /*#__PURE__*/react_default().createContext({}); // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
var Tooltip = /*#__PURE__*/function (_Component) {
  (0,inheritsLoose["default"])(Tooltip, _Component);
  ...
  function Tooltip() {
    ...
    _this.getArrowProps = function (props) {
      ...
      return (0,esm_extends["default"])({}, props, {
        style: (0,esm_extends["default"])({}, props.style, _this.props.arrowProps.style)
      });
    };
    ...
    _this.getTooltipProps = function (props) {
      ...
      return (0,esm_extends["default"])({}, props, _this.isTriggeredBy('hover') && {
        ...
        style: (0,esm_extends["default"])({}, props.style, _this.props.style)
      });
    };
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/react_default().createElement(TooltipContext.Provider, {
...
var TooltipTrigger = /*#__PURE__*/function (_Component) {
  (0,inheritsLoose["default"])(TooltipTrigger, _Component);
  ...
  function TooltipTrigger() {
    ...
    _this.showTooltip = function (_ref) {
      ...
      if (_this.props.followCursor) {
        state = (0,esm_extends["default"])({}, state, {
          pageX: pageX,
          pageY: pageY
        });
      }
    ...
    _this.getTriggerProps = function (props) {
      ...
      return (0,esm_extends["default"])({}, props, _this.isTriggeredBy('click') && {
      ...
      }, _this.isTriggeredBy('hover') && (0,esm_extends["default"])({
  ...
  _proto.render = function render() {
    ...
    var _this$props = this.props,
        ...
        restProps = (0,objectWithoutPropertiesLoose["default"])(_this$props, ["children", "tooltip", "placement", "trigger", "getTriggerRef", "modifiers", "closeOnReferenceHidden", "usePortal", "portalContainer", "followCursor", "getTooltipRef", "mutationObserverOptions"]);

    var popper = /*#__PURE__*/react_default().createElement(Popper, (0,esm_extends["default"])({
      ...
      return /*#__PURE__*/react_default().createElement(Tooltip, (0,esm_extends["default"])({
    ...
    return /*#__PURE__*/react_default().createElement(Manager, null, /*#__PURE__*/react_default().createElement(Reference, {
...
var Arrow = esm.styled.div({
  ...
  return {
    ...
    borderTopColor: match('top', placement, theme.color[color] || color || theme.base === 'light' ? (0,utils.lightenColor)(theme.background.app) : (0,utils.darkenColor)(theme.background.app), 'transparent'),
    borderBottomColor: match('bottom', placement, theme.color[color] || color || theme.base === 'light' ? (0,utils.lightenColor)(theme.background.app) : (0,utils.darkenColor)(theme.background.app), 'transparent'),
    borderLeftColor: match('left', placement, theme.color[color] || color || theme.base === 'light' ? (0,utils.lightenColor)(theme.background.app) : (0,utils.darkenColor)(theme.background.app), 'transparent'),
    borderRightColor: match('right', placement, theme.color[color] || color || theme.base === 'light' ? (0,utils.lightenColor)(theme.background.app) : (0,utils.darkenColor)(theme.background.app), 'transparent')
  };
});
var Wrapper = esm.styled.div(function (_ref3) {
  ...
  return hasChrome ? {
    background: theme.color[color] || color || theme.base === 'light' ? (0,utils.lightenColor)(theme.background.app) : (0,utils.darkenColor)(theme.background.app),
...
var Tooltip_Tooltip = function Tooltip(_ref5) {
  ...
  return /*#__PURE__*/react_default().createElement(Wrapper, _extends({
    hasChrome: hasChrome,
    placement: placement,
    ref: tooltipRef
  }, props, {
    color: color
  }), hasChrome && /*#__PURE__*/react_default().createElement(Arrow, _extends({
    placement: placement,
    ref: arrowRef
  }, arrowProps, {
    color: color
...
var WithTooltipPure = function WithTooltipPure(_ref) {
  ...
  return /*#__PURE__*/react_default().createElement(react_popper_tooltip, {
    placement: placement,
    trigger: trigger,
    modifiers: modifiers,
    ...
    tooltip: function tooltip(_ref2) {
      ...
      return /*#__PURE__*/react_default().createElement(Tooltip_Tooltip, WithTooltip_extends({
        hasChrome: hasChrome,
    ...
    return (
      /*#__PURE__*/
      // @ts-ignore
      react_default().createElement(Container, WithTooltip_extends({
        ref: triggerRef
...
var WithToolTipState = function WithToolTipState(_ref4) {
  ...
  return /*#__PURE__*/react_default().createElement(WithTooltipPure, WithTooltip_extends({}, rest, {
    tooltipShown: tooltipShown,
    onVisibilityChange: onVisibilityChange
  }));
};
