(globalThis["webpackChunkblinkist"] = globalThis["webpackChunkblinkist"] || []).push([["vendors-node_modules_storybook_components_dist_esm_syntaxhighlighter_syntaxhighlighter_js"],{
...
var Scroller = (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_32__.styled)(function (_ref6) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_17___default().createElement(_ScrollArea_ScrollArea__WEBPACK_IMPORTED_MODULE_33__.ScrollArea, {
    horizontal: true,
    vertical: true,
    className: className
  }, children);
...
var SyntaxHighlighter = function SyntaxHighlighter(_ref10) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_17___default().createElement(Wrapper, {
    bordered: bordered,
    padded: padded,
    className: className,
    onCopyCapture: onClick
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_17___default().createElement(Scroller, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_17___default().createElement(react_syntax_highlighter_dist_esm_prism_light__WEBPACK_IMPORTED_MODULE_20__["default"], _extends({
  ...
  }, rest), highlightableCode)), copyable ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_17___default().createElement(_ActionBar_ActionBar__WEBPACK_IMPORTED_MODULE_36__.ActionBar, {
    actionItems: [{
...
function createElement(_ref) {
  ...
  if (type === 'text') {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(TagName, (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_2__["default"])({
      key: key
    }, props), children);
  }
}
...
function AllLineNumbers(_ref2) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("code", {
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(defaultAstGenerator, defaultStyle) {
  return function SyntaxHighlighter(_ref7) {
    ...
    var allLineNumbers = showLineNumbers ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement(AllLineNumbers, {
    ...
    if (!astGenerator) {
      return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(PreTag, preProps, allLineNumbers, react__WEBPACK_IMPORTED_MODULE_0___default().createElement(CodeTag, codeTagProps, code));
    }
    /*
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(PreTag, preProps, react__WEBPACK_IMPORTED_MODULE_0___default().createElement(CodeTag, codeTagProps, !showInlineLineNumbers && allLineNumbers, renderer({
      rows: rows,
      stylesheet: style,
      useInlineStyles: useInlineStyles
    })));
